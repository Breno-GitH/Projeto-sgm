...
<body>
     <header>
       <nav class="navbar mb-4 shadow-sm" data-bs-theme="dark" style="background-color: #1a237e; border-bottom: 1px solid #283593;">
            <div class="container">
                <a class="navbar-brand" href="#">SGM - Gerenciamento de tipos de Serviço</a>
...
<main>
 <main class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="config_criar_tipo_servico.php" class="btn btn-success">+ Novo Tipo de Serviço</a>
        </div>
        ...
        <div class="table-responsive shadow-sm">
            <table class="table table-hover border">
                <thead class="table-light">
                    <tr>
                        <th scope="col">ID</th>
                        <th scope="col">Nome Tipos de Serviço</th>
     ...
     <tr>
      <th scope="row">1</th>
      <td>Eletrica</td>
      <td><a href="config_tipo_servico_detalhes.php"><button type="button" class="btn btn-primary">Gerenciar</button></a></td>
