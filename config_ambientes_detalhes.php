...
<main class="container-fluid py-4">
    <div class="mb-4">
        <a href="config_ambientes.php" class="btn btn-outline-secondary">Voltar</a>
    </div>  
    ...
    <h5 class="mb-0 d-flex align-items-center">
        <i class="bi bi-person-badge-fill me-2"></i> Editar Ambiente
    </h5>
</div>
     <div class="card-body">
                    <form id="formAtribuir"> <div class="mb-3">
                            <label for="selectAmbiente" class="form-label">Ambiente</label>
