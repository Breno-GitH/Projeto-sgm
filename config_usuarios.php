...
<body>
     <header>
       <nav class="navbar mb-4 shadow-sm" data-bs-theme="dark" style="background-color: #1a237e; border-bottom: 1px solid #283593;">
            <div class="container">
                <a class="navbar-brand" href="#">SGM - Gerenciamento de Usuario</a>
...
<main>
 <main class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1>Usuarios</h1> 
            <a href="config_criar_usuario.php" class="btn btn-success">+ Novo Usuario</a>
        </div>
     ...
     <tr>
      <th scope="row">1</th>
      <td>Admin Gestor</td>
      <td><a href="config_usuarios_detalhes.php"><button type="button" class="btn btn-primary">Gerenciar</button></a></td>
