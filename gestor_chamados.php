...
<body class="bg-light">
    ...
    <div class="container">
 <h2 class="mb-4 shadow-lg p-3 mb-5 text-white rounded-4 d-flex align-items-center border-0" 
    style="background: linear-gradient(45deg, #1a237e, #283593);">
    <i class="bi bi-clipboard2-check-fill me-3" style="color: #80d8ff;"></i> 
    Todos os Chamados
</h2>

        <div class="mb-3 d-flex gap-2">
            <button class="btn btn-secondary" onclick="carregarChamados('')">Todos</button>
            <button class="btn btn-primary" onclick="carregarChamados('aberto')">Abertos</button>
            <button class="btn btn-warning" onclick="carregarChamados('em_execucao')">Em Execução</button>
            <button class="btn btn-success" onclick="carregarChamados('concluido')">Concluídos</button>
        </div>
